...
\begin{figure}[ht!]
	\centering{
		...
		\caption{Демонстрация преломления}
...
\begin{figure}[ht!]
	\centering{
		\includegraphics[width=0.4\textwidth]{assets/coef-1.3.png}
		\caption{Демонстрация преломления}
		\label{img:13-coef}}
\end{figure}
...
\begin{figure}[ht!]
	\centering{
		\includegraphics[width=0.5\textwidth]{assets/coef-1.6.png}
		\caption{Демонстрация преломления}
		\label{img:16-coef}}
\end{figure}
...
Как видно из рисунка \ref{graph:r}, при глубине рекурсии больше шести изображение почти не изменяется, но время растет значительно относительно предыдущих шагов. Поэтому логично использовать глубину рекурсии не больше шести. 
